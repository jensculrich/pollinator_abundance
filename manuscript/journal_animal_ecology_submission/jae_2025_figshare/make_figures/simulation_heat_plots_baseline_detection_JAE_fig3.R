...
# read data
list1 <- readRDS("./simulation_full/simulation_outputs/baseline_detection/binmix_alpha1=1_beta0=0_beta1=-0.5.rds")
list2 <- readRDS("./simulation_full/simulation_outputs/baseline_detection/binmix_alpha1=1_beta0=0_beta1=0.rds")
list3 <- readRDS("./simulation_full/simulation_outputs/baseline_detection/binmix_alpha1=1_beta0=0_beta1=0.5.rds")
list4 <- readRDS("./simulation_full/simulation_outputs/baseline_detection/binmix_alpha1=1_beta0=0_beta1=1.rds")
list5 <- readRDS("./simulation_full/simulation_outputs/baseline_detection/binmix_alpha1=1_beta0=-1_beta1=-0.5.rds")
list6 <- readRDS("./simulation_full/simulation_outputs/baseline_detection/binmix_alpha1=1_beta0=-1_beta1=0.rds")
list7 <- readRDS("./simulation_full/simulation_outputs/baseline_detection/binmix_alpha1=1_beta0=-1_beta1=0.5.rds")
list8 <- readRDS("./simulation_full/simulation_outputs/baseline_detection/binmix_alpha1=1_beta0=-1_beta1=1.rds")
list9 <- readRDS("./simulation_full/simulation_outputs/baseline_detection/binmix_alpha1=1_beta0=-2_beta1=-0.5.rds")
list10 <- readRDS("./simulation_full/simulation_outputs/baseline_detection/binmix_alpha1=1_beta0=-2_beta1=0.rds")
list11 <- readRDS("./simulation_full/simulation_outputs/baseline_detection/binmix_alpha1=1_beta0=-2_beta1=0.5.rds")
list12 <- readRDS("./simulation_full/simulation_outputs/baseline_detection/binmix_alpha1=1_beta0=-2_beta1=1.rds")
list13 <- readRDS("./simulation_full/simulation_outputs/baseline_detection/binmix_alpha1=1_beta0=-3_beta1=-0.5.rds")
list14 <- readRDS("./simulation_full/simulation_outputs/baseline_detection/binmix_alpha1=1_beta0=-3_beta1=0.rds")
list15 <- readRDS("./simulation_full/simulation_outputs/baseline_detection/binmix_alpha1=1_beta0=-3_beta1=0.5.rds")
list16 <- readRDS("./simulation_full/simulation_outputs/baseline_detection/binmix_alpha1=1_beta0=-3_beta1=1.rds")
